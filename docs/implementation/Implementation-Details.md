...
#### 自然回復の周期処理
- [自然回復システム](../features/Natural-Recovery-System.md)に基づき、**10秒ごと**に HP とスタミナを最大値の **1%** 回復させます。
- 満腹度の状態（満腹、空腹、飢餓）に応じた回復補正を適用します。
  - **満腹 (80%以上)**: 回復量 1.2 倍
  - **空腹 (20%未満)**: 自然回復停止
  - **飢餓 (0%)**: 5秒ごとに最大HPの 1% ダメージ
